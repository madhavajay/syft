...
def apply_patch_to_branch(repo, patch_file_path, branch_name, my_datasite_branch, file_path=None):
    """
    ...
    try:
        ...
        for branch_name in branches:
            ...
            for patch_filepath, branch_name, file_path in patch_filepaths:
                apply_patch_to_branch(repo, patch_filepath, branch_name, my_datasite_branch, file_path)
